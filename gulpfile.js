...
// Copy all JS files
    var stream = gulp.src( paths.node + 'uikit/src/js/**/*.js' )
        .pipe( gulp.dest( paths.dev + '/js/uikit' ) );

// Copy all Bootstrap SCSS files
    gulp.src( paths.node + 'uikit/src/scss/**/*.scss' )
        .pipe( gulp.dest( paths.dev + '/scss/uikit' ) );
...
// Copy all Font Awesome SCSS files
    gulp.src( paths.node + 'font-awesome/scss/*.scss' )
        .pipe( gulp.dest( paths.dev + '/scss/fontawesome' ) );
});
