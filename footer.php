...
<?php if (get_post_meta(get_the_ID(), '_wha_hide_footer', true) != 'on') : ?>
        ...
        <div class="uk-container">
            <div class="uk-child-width-1-2@m uk-text-center" uk-grid>
                ...
                <div class="uk-flex-first@m uk-text-left@m">
                    <p class="uk-text-small">&copy; Copyright <?= date('Y') ?> <a target="_blank" href="http://webhelpagency.com/">Powered by WHA</a></p>
                </div>
            </div>
        </div>
    </section>
