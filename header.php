...
<div class="uk-offcanvas-content">
    <?php if (get_post_meta(get_the_ID(), '_wha_hide_header', true) != 'on') : ?>
        <?php $header_postion_fixed = get_theme_mod('wha_header_position_fixed'); ?>
        <header id="header" style="z-index: 980;"
                class="uk-navbar-container tm-navbar-container uk-navbar-transparent <?php if ($header_postion_fixed) {
                    echo 'uk-sticky uk-sticky-fixed uk-active uk-sticky-below"';
                } ?>
            uk-active">
